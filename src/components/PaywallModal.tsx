...
export default function PaywallModal({ isOpen, onClose, reason, format, userUsage, userId, userEmail, userName }: Props) {
    ...
    return (
        <div className="fixed inset-0 z-50 flex items-end md:items-center justify-center md:p-4">
            ...
            {/* Modal */}
            <div className="relative w-full max-w-md bg-white dark:bg-zinc-950/90 backdrop-blur-2xl rounded-t-2xl md:rounded-2xl shadow-2xl border border-zinc-200 dark:border-zinc-700/30 overflow-hidden animate-in slide-in-from-bottom-8 md:zoom-in-95 duration-500 ease-out max-h-[85vh]">
